...
#define BAT_CALIB_REAL_VOLTAGE  3740      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1457      // adc-value measured by mainboard (value nr 5 on UART debug output)
...
#define DEFAULT_STEER_COEFFICIENT   2048  // Defualt for STEER_COEFFICIENT 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0.
...
*/
  ...
  #define PRI_INPUT1            2, 3, 2040, 4090, 20      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            2, 6, 2080, 4090, 20      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
